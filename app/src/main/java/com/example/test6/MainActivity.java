...
//        items.put("Username",personName);
        ...
        items.put("Type",type);
        DocumentReference docRef = userdb.collection(type).document(personGivenName);
                                    ...
                                    else
                                    {
                                        docRef.set(items).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                storedata(personGivenName);
                                                Toast.makeText(MainActivity.this, "HELL YEAH", Toast.LENGTH_SHORT).show();
